<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="flower.aspx.cs" Inherits="SkyGardens.admin.flower" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitlePlaceholder" runat="server">
    SKU
    <asp:Label runat="server" ID="lbl_skuTitle"></asp:Label>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceholder" runat="server">
    <div class="constrained" x-data="{tab:'crud'}">
        <h3>
            <span runat="server" id="lbl_skuHeadingId" class="tag" />
            <span runat="server" id="lbl_skuHeadingName" />
        </h3>
        <input type="button" x-on:click="tab='crud'" :class="tab=='crud' ? 'active tab' : 'tab'" OnClientClick="return false;" value="SKU Details" /><input type="button" x-on:click="tab='stock'" :class="tab=='stock' ? 'active tab' : 'tab'" OnClientClick="return false;" value="Stock levels" />
        <div x-show="tab=='crud'">
            <div style="width: 100%;" class="form">
                <div class="block">
                    ...
                    <label for="txt_name">
                        ...
                        <br />
                        <span class="semi-transparent text-sm">Maximum 50 characters</span><br />
                    </label>
                ...
                <div class="block">
                    <label for="txt_name">
                        Discontinued<br />
                        <span class="semi-transparent text-sm">Select this to mark this SKU as discontinued (will no longer be stocked).</span>
                    </label>
                    <asp:CheckBox ID="ckb_discontinued" runat="server" />
                </div>
                <div class="block">
                    <label for="txt_name">
                        Origin<br />
            ...
            <div class="fluid-flex">
                ...
                <asp:Button runat="server" ID="btn_save" CssClass="blue" Style="width: 100%;" Text="Save" OnClick="btn_save_Click" />
                <asp:Button runat="server" ID="btn_delete" CssClass="red" Style="width: 100%;" Text="Delete" OnClick="btn_delete_Click" />
            </div>
        </div>
        <div x-show="tab=='stock'">
            <br />
            <asp:GridView ID="gv_stock" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" EmptyDataText="No sites are reporting stock levels for this SKU. It's possible it may have been discontinued. Please check the SKU details section." ForeColor="Black" GridLines="Horizontal">
